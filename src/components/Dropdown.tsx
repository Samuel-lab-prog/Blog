...
const menuClasses =
  'md:hidden fixed top-20 right-0 bg-gray-200 border-l-2 border-gray-300 shadow-lg p-5 z-30 w-48 h-full flex flex-col gap-y-3 transition-transform duration-300 ease-in-out overflow-hidden';
