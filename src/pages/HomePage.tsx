...
export default function Home() {
  ...
  const user = useUser();
  return (
    <main className="absolute left-0 top-20 flex flex-col w-full pb-12  ">
      <section className="px-4 xl:px-12 h-70 flex flex-col justify-center items-start">
      ...
      <section className="px-4 xl:px-12 flex flex-col items-start">
